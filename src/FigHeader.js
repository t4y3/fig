...
const openDialog = () => {
  const dialog = document.getElementById('modal-shortcuts');
  dialog.showModal();
};
...
const FigHeader = ({ state }) => (
  <div className="fig-header">
    ...
    <div className="header-logo">
      <i className="header-logo__keybord material-icons" onclick={openDialog}>
        keyboard
      </i>
    </div>
    <dialog id="modal-shortcuts" className="modal-shortcuts" onclick={closeDialog}>
      ...
      <p className="modal-shortcuts__item">
        <span>⌘ ⇧ ←</span>
        Toggle Tree View
      </p>
      <p className="modal-shortcuts__item">
